...
### 📊 Система оценки (Mod Checker)

| Уровень | Баллы | Описание |
|:-------:|:-----:|----------|
| 🟢 **Normal** | 0–14 | Ничего не найдено |
| 🔵 **Low** | 15–29 | Незначительные совпадения |
| 🟡 **Suspicious** | 30–49 | Требуется проверка |
| 🟠 **High** | 50–79 | Высокая вероятность чита |
| 🔴 **Critical** | 80+ | SHA-256 совпадение или множественные сигнатуры |
